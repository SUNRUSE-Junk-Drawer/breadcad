...
#define SDF_OPCODE_ID_POWER 0x04
...
#define SDF_OPCODE_POWER SDF_OPCODE(SDF_PRIMITIVE_NUMBER, SDF_PRIMITIVE_NUMBER, SDF_PRIMITIVE_NUMBER, SDF_PRIMITIVE_NONE, SDF_OPCODE_ID_POWER)
