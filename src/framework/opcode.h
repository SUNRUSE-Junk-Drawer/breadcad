...
#define SDF_OPCODE_ID_MIN 0x07
#define SDF_OPCODE_ID_MAX2 0x08
...
#define SDF_OPCODE_MIN SDF_OPCODE(SDF_PRIMITIVE_NUMBER, SDF_PRIMITIVE_NUMBER, SDF_PRIMITIVE_NUMBER, SDF_PRIMITIVE_NONE, SDF_OPCODE_ID_MIN)
#define SDF_OPCODE_MAX SDF_OPCODE(SDF_PRIMITIVE_NUMBER, SDF_PRIMITIVE_NUMBER, SDF_PRIMITIVE_NUMBER, SDF_PRIMITIVE_NONE, SDF_OPCODE_ID_MAX2)
